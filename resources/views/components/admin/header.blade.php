<div x-data='{ shown: false }'>
    <aside
        class="fixed left-0 top-0 bottom-0 z-30 flex flex-col items-center w-16 py-5 bg-white drop-shadow-xl dark:bg-gray-900 dark:border-gray-700">
        <nav class="flex flex-col flex-1 space-y-2">
            ...
            <a x-data="{ tooltip: false }" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false"
                href="{{ route('home') }}"
                class="p-1.5 text-blue-500 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-blue-200 dark:hover:bg-gray-800 hover:bg-blue-100 text-center">
    ...
    <div class="fixed px-5 py-3 bg-white left-0 ml-16 top-0 z-30 right-0 shadow-lg flex justify-between items-center">
        <livewire:admin.search>
            <div class="flex items-center gap-x-5">
                <i
                    class="ri-notification-3-line text-blue-500 ring-1 rounded-full px-1 ring-blue-300 dark:ring-blue-600"></i>
                <img x-cloak @click="shown = !shown"
                    class="object-cover w-10 h-10 rounded-full ring-1 ring-blue-300 dark:ring-blue-600"
