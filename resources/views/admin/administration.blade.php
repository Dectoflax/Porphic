...
<section x-data="{ admin: true }" class="container px-4 mx-auto">
    <div class="flex overflow-x-auto whitespace-nowrap justify-center items-center">
        <button x-cloak
            :class="[admin ? 'inline-flex items-center h-12 px-2 py-2 text-center text-gray-700 border border-b-0 border-gray-300 sm:px-4 dark:border-gray-500 rounded-t-md -px-1 dark:text-white whitespace-nowrap focus:outline-none' : 'inline-flex items-center h-12 px-2 py-2 text-center text-gray-700 bg-transparent border-b border-gray-300 sm:px-4 dark:border-gray-500 -px-1 dark:text-white whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400 dark:hover:border-gray-300']"
            @click="admin = true">
