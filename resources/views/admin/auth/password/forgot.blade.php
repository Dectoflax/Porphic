...
<div
    ...
    <div class="px-6 py-4">
        ...
        <h3 class="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Recover Password</h3>

        <p class="mt-1 text-center text-gray-500 dark:text-gray-400">Enter email to reset</p>
