...
@section('content')
<div class="lg:w-full mx-5 max-w-sm lg:mx-auto overflow-hidden bg-white rounded-lg drop-shadow-xl border-t">
    <div class="px-6 py-4">
        ...
        <p class="mt-1 text-center text-gray-500 ">Login to continue</p>
