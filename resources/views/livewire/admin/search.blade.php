<div x-data="{ searchVisible: @entangle('searchVisible') }">
    <div class="flex items-center w-40 lg:w-72">
        <span class="absolute">
            <i wire:loading.class='hidden' class="ri-search-line w-6 h-6 mx-3 text-gray-400"></i>
            <i wire:loading class="ri-loader-2-line animate-spin w-6 h-6 mx-3 text-blue-400"></i>
        </span>
