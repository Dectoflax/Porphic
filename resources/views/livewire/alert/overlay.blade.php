<div x-data="{ visible: @entangle('visible') }" x-show='visible'
    ...
    <div
        class="flex flex-col justify-center items-center w-60 lg:max-w-sm mx-2 z-30 overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 -mt-10 p-3">
        ...
        <div class="flex justify-center items-center flex-col m-3">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-200 mt-3">{{ $message }}</p>
        </div>
