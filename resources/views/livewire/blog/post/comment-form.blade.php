<form method="post" wire:submit.prevent='create' class="flex flex-col w-2/3">
    <div>
        <textarea placeholder="Comment here" class="w-full h-16 lg:h-20 ounline-none ring-1 ring-blue-500 rounded"
    ...
    <div class="flex justify-end items-center">
        <button type="submit" class="text-white bg-blue-500 px-6 py-1">
            ...
            <i wire:loading.class='hidden' class="ri-chat-forward-line"></i>
        </button>
    </div>
</form>
